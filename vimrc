...
" Remove bad habit of using arrow keys by disabling them
"noremap <Up> <NOP>
"noremap <Down> <NOP>
"noremap <Left> <NOP>
"noremap <Right> <NOP

" Enable Hard Mode (Disables arrow keys, hjkl, the page up/down keys)
...
" Write a file with root permissions by using :W command #
